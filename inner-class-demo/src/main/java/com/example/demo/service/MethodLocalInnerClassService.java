...
public class MethodLocalInnerClassService {
	...
	public void methodLocalInnerClassDemo() {
		int x = 2;
		// static int y = 343; //Illegal modifier for parameter y; only final is
		// permitted
		int j = 2;
		...
		class MethodClass {
			...
			public void display() {
				...
				// Local variable methodLocalVariable defined in an enclosing scope must be
				...
				System.out.println("MethodLocalInnerClassService.this => "
						+ MethodLocalInnerClassService.this.getClass().getName());
	...
	public static void staticMethodLocalInnerClassDemo() {
		...
		class MethodClass {
			...
			public void display() {
				...
				// System.out.println("MethodLocalInnerClassService.this =>
				// "+MethodLocalInnerClassService.this.getClass().getName());
				// System.out.println("MethodLocalInnerClassService.this.x :
				// "+MethodLocalInnerClassService.this.x);
				// System.out.println("MethodLocalInnerClassService.this.y :
				// "+MethodLocalInnerClassService.this.y);
				// System.out.println("MethodLocalInnerClassService.this.j :
				// "+MethodLocalInnerClassService.this.j);
