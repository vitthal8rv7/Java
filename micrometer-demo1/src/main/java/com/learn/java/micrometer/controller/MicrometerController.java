package com.learn.java.micrometer.controller;
...
import com.learn.java.micrometer.model.Employee;

@RestController
@RequestMapping("/logger/demo")
public class MicrometerController {

	private static Logger logger = LoggerFactory.getLogger(MicrometerController.class);
