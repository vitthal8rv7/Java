...
public class DeviceDetails {
	...
	public DeviceDetailsVO getDeviceDetailsVO() {
		// TODO Auto-generated method stub
//		DeviceDetails.builder..accessToken..accessToken.build()
		DeviceDetailsVO deviceDetails = new DeviceDetailsVO();
		deviceDetails.setDeviceTokenNew(deviceTokenNew);
		deviceDetails.setDeviceTokenOld(deviceTokenOld);
		deviceDetails.setUsername(username);
		deviceDetails.setOsName(osName);
		deviceDetails.setModelName(modelName);
		deviceDetails.setAccessToken(accessToken);
		deviceDetails.setOsVersion(osVersion);
		deviceDetails.setLastActive(lastActive);
		deviceDetails.setLastNudge(lastNudge);
		deviceDetails.setTimezone(timezone);
		deviceDetails.setNotificationIds(notificationIds);
		deviceDetails.setAccessToken(accessToken);
